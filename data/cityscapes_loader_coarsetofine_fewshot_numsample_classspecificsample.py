...
class cityscapesLoader_coarsetofine_fewshot_numsample_classspecific(data.Dataset):
    """cityscapesLoader
    ...
    def __init__(
        ...
        if split == 'train':
            ...
            vegetation_index = random.sample(list(range(len(self.vegetation_file))), num_sample)
