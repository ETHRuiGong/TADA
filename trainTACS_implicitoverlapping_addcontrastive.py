...
from loss_contrastive import PixelContrastLoss
...
def main():
    ...
    seg_contraloss = PixelContrastLoss(temperature=0.07, base_temperature=0.07)
    ...
    if True:
        ...
        train_dataset = data_loader(data_path, list_path = './data/synscapes_list/train.txt', augmentations=data_aug, img_size=(1280,720), mean=IMG_MEAN)
    ...
    for i_iter in range(start_iteration, num_iterations):
        ...
        if train_unlabeled:
            ...
            L_contra = seg_contraloss(logits_u_s_feat, targets_u,
                                      torch.max(logits_u_s, dim=1)[1])  # feats, labels=None, predict=None
