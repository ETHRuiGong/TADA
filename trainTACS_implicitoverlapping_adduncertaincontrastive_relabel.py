...
from data import get_loader_conflictclass_fewshot_numsample_classspecific, get_data_path
...
from evaluateTACS_16classes import evaluate
...
def main():
    ...
    if dataset == 'cityscapes':
        data_loader = get_loader_conflictclass_fewshot_numsample_classspecific('cityscapes')
        ...
        data_loader = get_loader_conflictclass_fewshot_numsample_classspecific('cityscapes_fewshot')
    ...
    if True:
        data_loader = get_loader_conflictclass_fewshot_numsample_classspecific('synscapes')
        data_path = get_data_path('synscapes')
        if random_crop:
        ...
        train_dataset = data_loader(data_path, list_path='./data/synscapes_list/train.txt', augmentations=data_aug,
    ...
    for i_iter in range(start_iteration, num_iterations):
        ...
        labels[(prob_select >= 0.67) & (labels == 13)] = 14
        labels[(prob_select >= 0.33) & (labels == 13) & (prob_select < 0.67)] = 15
        ...
        labels[(pred_relabel == 14) & (labels == 13) & (prob_select >= 0.0)] = 14
        labels[(pred_relabel == 15) & (labels == 13) & (prob_select >= 0.0)] = 15
        ...
        labels[(prob_select >= 0.7) & (labels_orig == 13)] = 14
        labels[(prob_select >= 0.4) & (labels_orig == 13) & (prob_select < 0.7)] = 15
        labels[(prob_select >= 0.7) & (labels_orig == 14)] = 13
        labels[(prob_select >= 0.4) & (labels_orig == 14) & (prob_select < 0.7)] = 15
        labels[(prob_select >= 0.7) & (labels_orig == 15)] = 14
        labels[(prob_select >= 0.4) & (labels_orig == 15) & (prob_select < 0.7)] = 13
...
if __name__ == '__main__':
    ...
    if args.resume:
        ...
        # checkpoint_dir = os.path.join(config['utils']['checkpoint_dir'], args.name)
        checkpoint_dir = os.path.join(config['utils']['checkpoint_dir'], args.name + '_resume')
