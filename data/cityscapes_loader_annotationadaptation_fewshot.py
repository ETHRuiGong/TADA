...
class cityscapesLoader_annotationadaptation_fewshot(data.Dataset):
    """cityscapesLoader
    ...
    def __init__(
        ...
        if split == 'train':
            self.files[split] = ["./CityScapes/leftImg8bit_trainvaltest/leftImg8bit/train/stuttgart/stuttgart_000055_000019_leftImg8bit.png", "./CityScapes/leftImg8bit_trainvaltest/leftImg8bit/train/aachen/aachen_000065_000019_leftImg8bit.png"]
        # else:
        #     self.files[split] = recursive_glob(rootdir=self.images_base, suffix=".png")
