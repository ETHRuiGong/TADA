...
class cityscapesLoader_16classes(data.Dataset):
    """cityscapesLoader
    ...
    def __init__(
        ...
        self.class_map = {7: 0, 8: 1, 11: 2, 12: 3, 13: 4, 17: 5,
                              ...
                              26: 13, 27: 13, 28: 14, 31: 14, 32: 15, 33: 15}
    ...
    #     b = temp.copy()
    #     for l in range(0, 19):
    #         r[temp == l_p] = self.label_colours[l_p][0]
    #         g[temp == l_p] = self.label_colours[l_p][1]
    #         b[temp == l_p] = self.label_colours[l_p][2]
    #
